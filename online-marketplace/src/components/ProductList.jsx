...
function ProductList() {
  ...
  function displayProducts() {
    switch (product) {
                ...
                <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
                  ...
                  <div class="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
                    <div class="group relative">
                      <div class="relative h-80 w-full overflow-hidden rounded-lg bg-white group-hover:opacity-75 sm:aspect-w-2 sm:aspect-h-1 sm:h-64 lg:aspect-w-1 lg:aspect-h-1">
                        <img
                          ...
                          class="h-full w-full object-cover object-center lg:h-full lg:w-full object-scale-down"
                        />
                      </div>
                    ...
                    <div class="group relative">
                      ...
                      <h3 class="mt-6 text-sm text-gray-500">
                        <button onClick={() => setProduct("pants")}>
                          {" "}
                          <span class="absolute inset-0"></span>
                          Pants
                        </button>
      ...
      case "shirts":
        return (
          <ShirtList product={product} setProduct={setProduct}></ShirtList>
        );
      case "pants":
        return (
          <PantsList product={product} setProduct={setProduct}></PantsList>
        );
      default:
        return null;
    }
